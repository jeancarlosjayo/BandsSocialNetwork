...
class ProfileBandaFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.fragment_profile_banda, container, false)
        ...
        nameBand = view.findViewById(R.id.namePBanda)
        rucBand = view.findViewById(R.id.rucPBanda)
        districtBand = view.findViewById(R.id.distritoPBanda)
        phoneBand = view.findViewById(R.id.celularPBanda)
        val query: Query =
        ...
        ref.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                for (ds in dataSnapshot.children) {
                    ...
                    adapterPosts = AdapterPosts(activity, this@ProfileBandaFragment.postList)
