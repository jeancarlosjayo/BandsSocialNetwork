...
public class AdapterChatClienteList extends RecyclerView.Adapter<AdapterChatClienteList.MyHolder> {
    Context mContext;
    List<ClienteUser> userList;

    private HashMap<String, String> lastMessageMap;

    public AdapterChatClienteList(Context mContext, List<ClienteUser> userList) {
