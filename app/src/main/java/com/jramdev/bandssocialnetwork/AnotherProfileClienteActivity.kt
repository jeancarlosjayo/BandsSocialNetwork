...
class AnotherProfileClienteActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_another_profile_cliente)
        ...
        phoneBand = findViewById(R.id.phonePCliente)
        rucBand = findViewById(R.id.edadPCliente)
        districtBand = findViewById(R.id.distritPCliente)
        ...
        ref.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                for (ds in dataSnapshot.children) {
                    ...
                    adapterPosts = AdapterPosts(this@AnotherProfileClienteActivity, postList)
