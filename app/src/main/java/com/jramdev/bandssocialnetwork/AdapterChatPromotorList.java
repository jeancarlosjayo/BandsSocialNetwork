...
public class AdapterChatPromotorList extends RecyclerView.Adapter<AdapterChatPromotorList.MyHolder> {
    Context mContext;
    List<PromotorUser> userList;

    private HashMap<String, String> lastMessageMap;

    public AdapterChatPromotorList(Context mContext, List<PromotorUser> userList) {
